...
public class BootstrapData2 implements CommandLineRunner {
    ...
    public BootstrapData2(AuthorRepository authorRepository, BookRepository bookRepository, PublisherRepository publisherRepository) {
    ...
    public void run(String... args) throws Exception {
        System.out.println("Started in Bootstrap 2");
